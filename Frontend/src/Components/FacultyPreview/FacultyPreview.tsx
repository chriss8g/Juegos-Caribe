...
export default function FacultyPreview({name, image})
{
    return(
        name !== undefined && image !== undefined &&
            <div className="flex lg:flex-[0_0_auto] flex-col justify-center align-center lg:ml-2 lg:mr-2  px-1 py-[5%] rounded-[15px] w-10/12 h-[25vh] mx-1 shadow-lg  lg:py-[2%] lg:px-[2.5%] lg:w-[26%]">
